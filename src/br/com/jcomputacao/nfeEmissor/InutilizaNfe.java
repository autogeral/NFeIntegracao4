...
import br.inf.portalfiscal.nfe.xml.pl009v4_2021.nfes.TInutNFe;
import br.inf.portalfiscal.nfe.xml.pl009v4_2021.nfes.TInutNFe.InfInut;
import br.inf.portalfiscal.nfe.xml.pl009v4_2021.nfes.TNFe.InfNFe.Ide;
import br.inf.portalfiscal.nfe.xml.pl009v4_2021.nfes.TProcInutNFe;
import br.inf.portalfiscal.nfe.xml.pl009v4_2021.nfes.TRetInutNFe;
        ...
        try {
            ...
            if (rinf != null && rinf.getCStat() != null) {
                ...
                if (status == 102) {
                    ...
                    xml = xml.replaceAll("xmlns:ns2=\".+#\"\\s", "").replaceAll("ns2:", "");
                    retorno = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>" + retorno.replaceAll("�", "a").replaceAll("�", "c").replaceAll("�", "u");
